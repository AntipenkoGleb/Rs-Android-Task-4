...
@BindingAdapter("setItemList", "setImageList", "setSelected", "selectedAttrChanged", requireAll = false)
fun setDropDownItemList(
...
private fun getAdapter(context: Context, itemArray: Array<String>, imageArray: TypedArray?): DataBindingArrayAdapter<*, *> {
    return if (imageArray == null) {
        ...
        DataBindingArrayAdapter<ImageListItem<String, Drawable?>, ListImageItemBinding>(context, R.layout.list_image_item, items)
